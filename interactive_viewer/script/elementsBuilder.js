(function () {
  ...
  /**
   * Resolve an icon path from a dot_json node into something the browser can
   * load: local site-packages paths get rewritten to the GitHub CDN, absolute
   * URLs/data/blob URIs pass through unchanged.
