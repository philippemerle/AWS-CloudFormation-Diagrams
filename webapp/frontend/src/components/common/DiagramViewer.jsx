 ...
 * Supports: DOT_JSON (interactive), PDF, DOT, MERMAID, D2, SVG, PNG, JPG, GIF, DRAWIO
 */
...
mermaid.initialize({
  ...
  // Default maxTextSize (50000) is too low for real templates with many resources
  maxTextSize: 1000000,
  maxEdges: 2000,
});
...
function DiagramViewer({
    ...
    return (
      <div className="w-full h-[70vh] border rounded overflow-hidden bg-white">
        <iframe
          ...
          title="AWS CFN Interactive Viewer"
          className="w-full h-full"
          onLoad={onViewerLoad}
        />
      </div>
    ...
    return (
      <div className="w-full h-[82vh] border rounded overflow-hidden bg-white">
        <object
          ...
          className="w-full h-full"
        >
          <p className="p-4 text-gray-600">Your browser cannot display the PDF here.</p>
        </object>
      </div>
    );
  }
  ...
  // SVG/PNG/JPG/JPEG/GIF - Image viewer with pan & zoom
  return (
